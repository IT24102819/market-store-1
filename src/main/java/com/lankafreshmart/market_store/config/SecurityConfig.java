    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests((requests) -> requests
                        .requestMatchers("/", "/register", "/privacy", "/login", "/products", "/product-reviews-guest","/delivery/{deliveryId}/update","/delete-account","/admin-register", "/guest-cart/add", "/guest-cart/view", "/css/**", "/js/**", "/images/**").permitAll()
